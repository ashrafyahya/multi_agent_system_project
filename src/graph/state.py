...
class WorkflowState(TypedDict, total=False):
    ...
    Attributes:
        ...
        source_quality_warnings: List of source quality warning messages
            generated by SourceQualityValidator (non-blocking)
        data_verification_summary: Optional dictionary containing data verification
            statistics (total_metrics, verified, estimated, not_found)
        data_collection_timestamp: Optional timestamp when data collection completed
        source_statistics: Optional detailed source statistics by quality category
        user_query: Optional string containing the original user query for transparency
    """
    ...
    data_verification_summary: dict[str, Any] | None
    data_collection_timestamp: str | None
...
def create_initial_state(
    ...
    Args:
        ...
        user_query: Optional original user query string for transparency.
    ...
    return WorkflowState(
        ...
        data_verification_summary=None,
